                ...
                <form method="post" action="{{ url('update/post/'.$post->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-layout">
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label">Post Title Spanish: <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="post_title_es"  value="{{ $post->post_title_es }}">
                                </div>
                            </div><!-- col-4 -->
