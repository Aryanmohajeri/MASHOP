    ...
    <div class="sl-mainpanel">
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                ...
                @elseif($order->status == 1)
                    <a href="{{ url('admin/delivery/process/'.$order->id) }}" class="btn btn-info">Processing Delivery </a>
                @elseif($order->status == 2)
                    <a href="{{ url('admin/delivery/done/'.$order->id) }}" class="btn btn-success">Delivered </a>
