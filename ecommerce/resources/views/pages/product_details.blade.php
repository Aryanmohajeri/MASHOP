                        ...
                        <div class="order_info d-flex flex-row">
                            <form action="{{url('cart/product/add/'.$product->id)}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    {{--If product isn't available in that size, the size is not shown--}}
                                    @else
                                    <div class="col-lg-4">
                                        {{--Drop down menu for Color option--}}
                                    ...
                                    <div class="col-lg-4">
                                        @if($product->product_color == NULL)
                                            {{--If product isn't available in that color, the color is not shown--}}
                                        @else
                                        {{--Drop down menu for Size options--}}
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            @if($product->raffle == 1)
                                                ...
                                                <input class="form-control" readonly type="number" value="1" pattern="[0-9]" name="qty" min="1" max="1">
                                            @else
                                                <label for="exampleFormControlSelect1">Quantity</label>
                                                <input class="form-control" type="number" value="1" pattern="[0-9]" name="qty" min="1" max="10">
                                            @endif
