...
@section('content')
                                        ...
                                        <div class="form-group">
                                            @if($product->raffle == 1)
                                                ...
                                                <input class="form-control" readonly type="number" value="1"
                                                       pattern="[0-9]" name="qty" min="1" max="1">
                                            @else
                                                <label for="exampleFormControlSelect1">Quantity</label>
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v9.0"
            nonce="pLPUrGnG"></script>
    <!-- Go to www.addthis.com/dashboard to customize your tools -->
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-6011c3ac3531b360"></script>
