                    ...
                    <div class="contact_form_container">
                        ...
                        <ul class="list-group col-lg-8" style="float: right;">
                            @if(Session::has('coupon'))
                                ...
                                <li class="list-group-item" style="color: green">Coupon :
                            ...
                            <li class="list-group-item">20% Vat : <span
                                    style="float: right;">£{{ Cart::Subtotal() * $vat }} </span></li>
                            @if(Session::has('coupon'))
                                <li class="list-group-item">Total : <span
                                        style="float: right;">£{{ Session::get('coupon')['balance'] + $charge  }} </span>
                                </li>
                            @else
                                <li class="list-group-item">Total : <span
                                        style="float: right;">£{{ Cart::Subtotal() + $charge  }} </span></li>
                            @endif
                        </ul>
                    ...
                    <div class="contact_form_container">
                        ...
                        <form action="{{ route('payment.process') }}" id="contact_form" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" aria-describedby="emailHelp"
                                       placeholder="Enter Your Post Code" name="postcode" required="">
                            </div>
                            ...
                            <label>
                                ...
                                <img src="{{ asset('public/frontend/images/paypal.png') }}" width=100px height=50px
                                     alt="Pay with Paypal">
                            </label>

                            <label>
                                <input type="radio" name="payment" value="stripe">
                                <img src="{{ asset('public/frontend/images/card.png') }}" width=100px height=50px
                                     alt="Accepting Visa, Mastercard, Discover and American Express">
                            </label>
                            <br>
                            <div id="paypal-button-container"></div>
                            <div id="card-button-container" type="submit" class="hidden">
                        ...
                        <script
                            src="https://www.paypal.com/sdk/js?client-id=AVDUASMsgbjuayLNS8ohjXTqJmcCVbPkUfTROHKa_W670Ih9j588Gw1TRSwKbsc7r-SxfoBmfNyEIXE7&currency=GBP"></script>
