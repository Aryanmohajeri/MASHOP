...
<div class="col-lg-5" style="border: 1px solid grey; padding: 20px; border-radius: 25px;">
            ...
            @if( Cart::content()->first()->options->category_id == 13)
 ...
 <input type="hidden" name="ship_postcode" value="{{ $data['postcode'] }} ">
...
var stripe = Stripe('pk_test_51HsrhgD6XdWLRroOSCUy1KwFQn5TNYWN2ZbS3rj9Jgt5Wo6ap2Vphyaih7osUYlI3SIhK9JcTUf8TTYUWMlOt7Cw00aHUJ0wLB');
