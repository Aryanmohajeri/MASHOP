                ...
                <div class="col-lg-12">
                    <div class="cart_container">
                        ...
                        <div class="cart_items">
                            <ul class="cart_list">
                                ...
                                <li class="cart_item clearfix">
                                    <div class="cart_item_image"><br><img src="{{asset($row->options->image)}}" style="width:70px; width: 70px" alt=""></div>
                                    <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                        ...
                                        <div class="cart_item_quantity cart_info_col">
                                            ...
                                            <div class="cart_item_text">{{$row->qty}}</div><br>
                                        </div>
                        ...
                        <div class="cart_buttons">
                            <button type="button" class="button cart_button_clear">Delete Items</button>
